...
- Added support for [mapping non-scalar values](README.md#map-non-scalar-values-fieldsmapnonscalarvalues) to Lightstreamer fields. ([#43](https://github.com/Lightstreamer/Lightstreamer-kafka-connector/pull/43))
