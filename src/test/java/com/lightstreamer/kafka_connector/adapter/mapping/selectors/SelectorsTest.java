  ...
  static Stream<Arguments> wrongArguments() {
    return Stream.of(
        ...
        arguments(
            ...
            "Found the invalid indexed expression [VALUE.attrib[]] while evaluating [name]"),
        arguments(
            Map.of("name", "VALUE.attrib[0]xsd"),
            "Found the invalid indexed expression [VALUE.attrib[0]xsd] while evaluating [name]"),
        arguments(
            Map.of("name", "VALUE.attrib[1]xsd"),
            "Found the invalid indexed expression [VALUE.attrib[1]xsd] while evaluating [name]"),
        arguments(
        ...
        arguments(
            ...
            "Found the invalid indexed expression [VALUE.attrib[1]xsd] while evaluating [name]"),
        arguments(
            Map.of("name", "KEY."), "Found the invalid expression [KEY.] while evaluating [name]"),
        arguments(
            Map.of("name", "KEY.."),
        ...
        arguments(
            Map.of("name", "\"\""), "Found the invalid expression [\"\"] while evaluating [name]"));
  }
  ...
  public void shouldNotCreateGenericRecordSelectors(
    ...
    ExpressionException exception =
        assertThrows(
            ...
            () -> Selectors.from(SelectorsSuppliers.avro(avroConfig()), "schema", input));
  ...
  public void shouldNotCreateJsonNodeSelectors(
    ...
    ExpressionException exception =
        assertThrows(
            ...
            () ->
                Selectors.from(
                    SelectorsSuppliers.json(ConnectorConfigProvider.minimal()), "schema", input));
    assertThat(exception.getMessage()).isEqualTo(expectedErrorMessage);
  }
