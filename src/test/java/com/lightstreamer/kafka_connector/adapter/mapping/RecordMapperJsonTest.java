...
public class RecordMapperJsonTest {
    ...
    private static Selectors<String, JsonNode> selectors(String schemaName, Map<String, String> entries) {
        return Selectors.from(SelectorsSuppliers.jsonValue(ConnectorConfigProvider.minimal()), schemaName, entries);
    }
    ...
    public void shouldBuildMapperWithDuplicateSelectors() {
        RecordMapper<String, JsonNode> mapper = builder()
    ...
    public void shoulMapEmpty() {
        ...
        ConsumerRecord<String, JsonNode> kafkaRecord = ConsumerRecords.record("", JsonNodeProvider.RECORD);
    ...
    public void shoulNotFilterDueToUnboundSelectors() {
        ...
        Selectors<String, JsonNode> unbonudSelectors = selectors("test", Map.of("name", "VALUE.any"));
    ...
    public void shouldFilter() {
        ...
        Selectors<String, JsonNode> childSelectors1 = selectors("test",
                Map.of("firstChildName", "VALUE.children[0].name"));

        Selectors<String, JsonNode> childSelectors2 = selectors("test",
