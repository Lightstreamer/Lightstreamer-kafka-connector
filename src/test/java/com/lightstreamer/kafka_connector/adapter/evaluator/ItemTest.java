...
public class ItemTest {
    ...
    public void shouldNotCreateDueToDuplicatedKeys() {
        assertThrows(RuntimeException.class, () -> {
            new Item("source", "item", Map.of("a","A", "a", "B"));
        });
    }
    ...
    //         """)
    // public void shouldMakeItemWithMoreSelectors(String input, String name1, String val1, String name2,
    //         String value2) throws EvaluationException {
    //     Object handle = new Object();
    //     Item item = Item.of(input, handle);
    //     assertThat(item).isNotNull();
    //     assertThat(item.getItemHandle()).isSameInstanceAs(handle);
