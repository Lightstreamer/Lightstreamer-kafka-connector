...
- [Lightstreamer Server](https://lightstreamer.com/download/) version 7.4.8 or later (check the `LS_HOME/GETTING_STARTED.TXT` file for the instructions)
...
2. Verify that the server is up and running by looking at the logs from the `LS_HOME/logs` directory:
   ...
   14.Mar.24 17:55:12,880 < INFO> Lightstreamer Server 7.4.8 build 3506 starting...
