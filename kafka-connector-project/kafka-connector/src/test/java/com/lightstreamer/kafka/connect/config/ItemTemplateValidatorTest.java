...
public class ItemTemplateValidatorTest {
    ...
    @CsvSource(
            ...
            textBlock =
                    ...
                    :                                                | Invalid value for configuration "item.templates": Each entry must be in the form [templateName]:[template]
                    ...
                    template-name:t1-prefix-#{}                      | Invalid value for configuration "item.templates": Template must be in the form [item-prefix-#{par1=val1,...parN=valN}]
                    template-name                                    | Invalid value for configuration "item.templates": Each entry must be in the form [templateName]:[template]
                    template-name:                                   | Invalid value for configuration "item.templates": Each entry must be in the form [templateName]:[template]
