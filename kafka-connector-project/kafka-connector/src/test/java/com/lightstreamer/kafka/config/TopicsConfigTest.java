...
public class TopicsConfigTest {
    ...
    void shouldConfigOneToOneTemplate() {
        ...
        TopicsConfig topicConfig = TopicsConfig.of(templateConfigs, topicMappingCofnigs);
        ...
        EvaluatedExpression ee = itemReference.template();
        assertThat(ee.prefix()).isEqualTo("template1");
        assertThat(ee.params()).containsExactly("a", "b");
    }
    ...
    void shouldConfigOneToManyTemplates() {
        ...
        TopicsConfig topicsConfig = TopicsConfig.of(templateConfigs, topicMappingConfigs);
        ...
        EvaluatedExpression ee1 = itemReference1.template();
        assertThat(ee1.prefix()).isEqualTo("template1");
        assertThat(ee1.params()).containsExactly("a", "b");

        ItemReference itemReference2 = itemReferences.get(1);
        EvaluatedExpression ee2 = itemReference2.template();
        assertThat(ee2.prefix()).isEqualTo("template2");
        assertThat(ee2.params()).containsExactly("c", "d");
    }
    ...
    void shouldConfigOneToManyIndenticalTemplates() {
        ...
        EvaluatedExpression ee1 = itemReference.template();
        assertThat(ee1.prefix()).isEqualTo("template1");
        assertThat(ee1.params()).containsExactly("a", "b");
    }
    ...
    void shouldConfigOneToManyIndenticalItems() {
        ...
        TopicsConfig topicsConfig =
                TopicsConfig.of(ItemTemplateConfigs.empty(), topicMappingConfigs);
