...
public class SchemaRegistryConfigsTest {
    ...
    void shouldReturnConfigSpec() {
        ...
        assertThat(schemaRegistryProvider.required()).isTrue();
        ...
        ConfParameter sslProtocol =
                configSpec.findParameter(SchemaRegistryConfigs.CONFLUENT_SSL_PROTOCOL);
        assertThat(sslProtocol.name()).isEqualTo(SchemaRegistryConfigs.CONFLUENT_SSL_PROTOCOL);
        ...
        ConfParameter trustStoreType =
                configSpec.findParameter(SchemaRegistryConfigs.CONFLUENT_TRUSTSTORE_TYPE);
        assertThat(trustStoreType.name())
                .isEqualTo(SchemaRegistryConfigs.CONFLUENT_TRUSTSTORE_TYPE);
        ...
        ConfParameter trustStorePath =
                configSpec.findParameter(SchemaRegistryConfigs.CONFLUENT_TRUSTSTORE_PATH);
        assertThat(trustStorePath.name())
                .isEqualTo(SchemaRegistryConfigs.CONFLUENT_TRUSTSTORE_PATH);
        ...
        ConfParameter trustStorePassword =
                configSpec.findParameter(SchemaRegistryConfigs.CONFLUENT_TRUSTSTORE_PASSWORD);
        assertThat(trustStorePassword.name())
                .isEqualTo(SchemaRegistryConfigs.CONFLUENT_TRUSTSTORE_PASSWORD);
        ...
        ConfParameter enableHostNameVerification =
                configSpec.findParameter(
                        SchemaRegistryConfigs.CONFLUENT_HOSTNAME_VERIFICATION_ENABLE);
        assertThat(enableHostNameVerification.name())
                .isEqualTo(SchemaRegistryConfigs.CONFLUENT_HOSTNAME_VERIFICATION_ENABLE);
        ...
        ConfParameter sslCipherSuites =
                configSpec.findParameter(SchemaRegistryConfigs.CONFLUENT_SSL_CIPHER_SUITES);
        assertThat(sslCipherSuites.name())
                .isEqualTo(SchemaRegistryConfigs.CONFLUENT_SSL_CIPHER_SUITES);
        ...
        ConfParameter sslProviders =
                configSpec.findParameter(SchemaRegistryConfigs.CONFLUENT_SSL_PROVIDER);
        assertThat(sslProviders.name()).isEqualTo(SchemaRegistryConfigs.CONFLUENT_SSL_PROVIDER);
        ...
        ConfParameter sslEngineFactoryClass =
                configSpec.findParameter(SchemaRegistryConfigs.CONFLUENT_SSL_ENGINE_FACTORY_CLASS);
        assertThat(sslEngineFactoryClass.name())
                .isEqualTo(SchemaRegistryConfigs.CONFLUENT_SSL_ENGINE_FACTORY_CLASS);
        ...
        ConfParameter sslKeyManagerAlgorithm =
                configSpec.findParameter(SchemaRegistryConfigs.CONFLUENT_SSL_KEYMANAGER_ALGORITHM);
        assertThat(sslKeyManagerAlgorithm.name())
                .isEqualTo(SchemaRegistryConfigs.CONFLUENT_SSL_KEYMANAGER_ALGORITHM);
        ...
        ConfParameter sslSecureRandomImplementation =
                configSpec.findParameter(
                        SchemaRegistryConfigs.CONFLUENT_SSL_SECURE_RANDOM_IMPLEMENTATION);
        assertThat(sslSecureRandomImplementation.name())
                .isEqualTo(SchemaRegistryConfigs.CONFLUENT_SSL_SECURE_RANDOM_IMPLEMENTATION);
        ...
        ConfParameter sslTrustManagerAlgorithm =
                configSpec.findParameter(
                        SchemaRegistryConfigs.CONFLUENT_SSL_TRUSTMANAGER_ALGORITHM);
        assertThat(sslTrustManagerAlgorithm.name())
                .isEqualTo(SchemaRegistryConfigs.CONFLUENT_SSL_TRUSTMANAGER_ALGORITHM);
        ...
        ConfParameter securityProviders =
                configSpec.findParameter(SchemaRegistryConfigs.CONFLUENT_SECURITY_PROVIDERS);
        assertThat(securityProviders.name())
                .isEqualTo(SchemaRegistryConfigs.CONFLUENT_SECURITY_PROVIDERS);
        ...
        ConfParameter keyStoreType =
                configSpec.findParameter(SchemaRegistryConfigs.CONFLUENT_KEYSTORE_TYPE);
        assertThat(keyStoreType.name()).isEqualTo(SchemaRegistryConfigs.CONFLUENT_KEYSTORE_TYPE);
        ...
        ConfParameter keystorePath =
                configSpec.findParameter(SchemaRegistryConfigs.CONFLUENT_KEYSTORE_PATH);
        assertThat(keystorePath.name()).isEqualTo(SchemaRegistryConfigs.CONFLUENT_KEYSTORE_PATH);
        ...
        ConfParameter keystorePassword =
                configSpec.findParameter(SchemaRegistryConfigs.CONFLUENT_KEYSTORE_PASSWORD);
        assertThat(keystorePassword.name())
                .isEqualTo(SchemaRegistryConfigs.CONFLUENT_KEYSTORE_PASSWORD);
        ...
        ConfParameter keyPassword =
                configSpec.findParameter(SchemaRegistryConfigs.CONFLUENT_KEY_PASSWORD);
        assertThat(keyPassword.name()).isEqualTo(SchemaRegistryConfigs.CONFLUENT_KEY_PASSWORD);
