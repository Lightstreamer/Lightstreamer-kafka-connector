...
public class ItemReferenceTest {
    ...
    void shouldCreateTemplates() {
        ItemReference i1 =
                ItemReference.template(
                        new EvaluatedExpression("template-prefix", Map.of("a", "b")));
        assertThat(i1.isTemplate()).isTrue();
        assertThat(i1.template().prefix()).isEqualTo("template-prefix");
        assertThat(i1.template().params()).containsExactly("a", "b");
    ...
    void shouldCreateTemplateFromFactoryMethod() {
        ...
        assertThat(i1.isTemplate()).isTrue();
        EvaluatedExpression ee = i1.template();
        assertThat(ee.prefix()).isEqualTo("template");
        assertThat(ee.params()).containsAtLeast("a", "b");
    }
    ...
    void shouldNotCreateTemplateFromFactoryMethodDueToEmotyTemplateName() {
        ...
        assertThat(ce.getMessage()).isEqualTo("Item template must be a non-empty string");
    }
