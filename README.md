...
Get the deployment package from the [latest release page](releases/latest). Alternatively, check out this repository and run the following command from the project root;
