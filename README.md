...
4. _producer_: a native Kafka Producer, based on the provided [`Dockerfile.producer`](examples/quickstart-producer/Dockerfile) file and the [kafka-connector-samples](kafka-connector-samples/) submodule of this repository
