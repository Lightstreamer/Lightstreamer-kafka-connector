...
- [Installation](#installation)
  ...
  - [Start](#start)
    - [Launch Lightstreamer Server](#1-launch-lightstreamer-server)
    - [Attach a Lightstreamer consumer](#2-attach-a-lightstreamer-consumer)
    - [Publish the events](#3-publish-the-events)
    - [Check the consumed events](#4-check-the-consumed-events)
