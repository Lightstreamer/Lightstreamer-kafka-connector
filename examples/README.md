...
- [quickstart-confluent-cloud](vendors/confluent/quickstart-confluent-cloud/): the _Quick Start_ app with the _Confluent Cloud Platform_ as the target broker
...
- [quickstart-aws](vendors/aws/quickstart-msk/): the _Quick Start_ app with _Amazon MSK_ as the target Kafka cluster
