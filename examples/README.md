...
- [quickstart-redpanda-selfmanaged](vendors/redpanda/quickstart-redpanda-selfmanaged/): the _Quickstart_ app with _Redpanda_ as the target broker
...
- [quickstart-azure](vendors/azure/quickstart-azure/): the _Quickstart_ app with _Azure Events Hub_ as the target Kafka cluster
